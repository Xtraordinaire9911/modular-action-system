...
| Open-web failure coverage | Gap report complete | Open-web failure modes are explicitly separated into mechanism-ready, controlled evidence, and real open-web evidence levels. Current report covers 8 failure classes and records zero real open-web evidence, preventing smart-room evidence from being overclaimed as broad open-web coverage. | `tests/test_open_web_failure_coverage.py`; `artifacts/open_web_failure_coverage/open_web_failure_coverage_report.json` |
